  ...
  <section id="intro">
        <div id="intro-info">
            <div>
                ...
                <div id="intro-tag-btn"> 
                    ...
                    <Link to='/' className="brand-btn">Let's Talk</Link> 
                </div>
            </div>
        </div>
    ...
    <section id="delivery">
        ...
        <div className="col-7">
            ...
            <div className="btn-footer">
                <Link to="/" className="brand-btn">Contact Us</Link> 
            </div>
        </div>
    </section>
    ...
    <section id="services">
        ...
        <div id="service-footer">
            <Link to="/" className="brand-btn">View All Service</Link> 
        </div>
    </section>
    ...
    <section id="revenue" className="brand-logos">
        ...
        <div>
            <Link to="/"><img src="https://www.dropbox.com/s/lmvtthec9yn0ti6/Allianz.png?raw=1" alt="Allianz" title="Work with Allianz" /></Link> 
            <Link ><img src="https://www.dropbox.com/s/kotgq2u4qr34i2u/audi.jpg?raw=1" alt="Audi" title="Work with Audi" /></Link> 
            <Link ><img src="https://www.dropbox.com/s/t5dapt3lkz7rdhe/BMW.png?raw=1" alt="BMW" title="Work with BMW" /></Link> 
            <Link ><img src="https://www.dropbox.com/s/ocqbsbgj590ztyy/ESPN.png?raw=1" alt="ESPN" title="Work with ESPN" /></Link> 
            <Link ><img src="https://www.dropbox.com/s/2maaqxijcmbaqxg/LG.png?raw=1" alt="LG" title="Work with LG" /></Link> 
            <Link ><img src="https://www.dropbox.com/s/yn3gj203hrdjfu7/Logo_NIKE.png?raw=1" alt="Nike" title="Work with Nike" /></Link> 
            <Link ><img src="https://www.dropbox.com/s/gfxa6exv7h1ro6q/Suzuki_logo.png?raw=1" alt="Suzuki" title="Work with Suzuki" /></Link> 
            <Link ><img src="https://www.dropbox.com/s/b7vwmjf6e0owybv/Visa.svg?raw=1" alt="Visa" title="Work with Visa" /></Link> 
        </div>
    </section>    
        ...
        <div className="slider">
            <div className="col-6 slide-text">
                <div>
                    ...
                    <Link to="/" className="brand-btn">See More</Link> 
                </div>
            </div>
            <div className="col-6 slide-img">
    ...
    <section id="partners" className="brand-logos">
        ...
        <div>
            <Link ><img src="https://www.dropbox.com/s/mk5ca04seizpf8l/aws.svg?raw=1" alt="Work with AWS" title="Our Work" /></Link> 
            <Link ><img src="https://www.dropbox.com/s/r9utt5nj9k9m1t8/Dell.png?raw=1" alt="Dell" title="Work with Dell" /></Link> 
            <Link ><img src="https://www.dropbox.com/s/umw9g0zgm1ecfvn/Intel.png?raw=1" alt="intel" title="Work with intell" /></Link> 
            <Link ><img src="https://www.dropbox.com/s/x0hrha2dosey99z/ibm.png?raw=1" alt="IBM" title="Work with IBM" /></Link> 
            <Link ><img src="https://www.dropbox.com/s/ekzu1wcki6jziay/Microsoft.svg?raw=1" alt="Microsoft" title="Work with Microsoft" /></Link> 
            <Link ><img src="https://www.dropbox.com/s/lvl5cp14i3v0wgi/Nasscom.png?raw=1" alt="Nasscom" title="Work with Nasscom" /></Link> 
            <Link ><img src="https://www.dropbox.com/s/h66k9jaaknxaum4/Samsung.png?raw=1" alt="Samsung" title="Work with Samsung" /></Link> 
            <Link ><img src="https://www.dropbox.com/s/86cbtf78khj0q9z/Nvidia.png?raw=1" alt="Nvidia" title="Work with Nvidia" /></Link>             </div>
    </section>
