            ...
            <div className="row">                
                <div className="content-column col-lg-6 col-md-12 col-sm-12 order-2">
                    <div className="inner-column">
                        ...
                        <div className="text">I am We works at Css3 Transition since last 3 years. We are here to provide touch notch solution for your website or web application that helps you to make your website look attractive & efficient in handling by creating usefull plugins thats you need.</div>
                      <div className="text">
                        ...
                        <div className="btn-box">
                            <Link to='/' className="theme-btn brand-btn">Contact Us</Link>
                        </div>
                    </div>
                </div>
                ...
                <div className="image-column col-lg-6 col-md-12 col-sm-12">
                    <div className="inner-column wow fadeInLeft">
                      <div className="author-desc">
                        ...
                        <figure className="image-1"><Link to='/' className="lightbox-image" data-fancybox="images"><img title="Rose" src="https://i.ibb.co/QP6Nmpf/image-1-about.jpg" alt="" /></Link></figure>
